...
{
    public $config, $accessToken, $refreshToken, $expirationToken;
    ...
    {
        if ($this->isInvalidOrExpireToken()) return $this->config->fetchAccessTokenWithRefreshToken($refresh_token);
